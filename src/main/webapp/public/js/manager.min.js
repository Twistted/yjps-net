    ...
    var createTable = function (result) {
    	...
    	for(var i = 0 ; i < result.houseListSize;i++){
    		$("#table_list tbody").append("<tr id='" + result.houseList[i].houseId + "'>" +
    									"<td>" + '<a href="#" class="table_list_a">' + result.houseList[i].houseNumber +'</a>'+ "</td>" +
    									...
    									"<td>" + "<span class='actionForList actionForList_del' id='" + result.houseList[i].houseId + "'>" + "删除" + "</span>" +
    											"<span>" + "|" + "</span>" + "<span class='actionForList actionForList_add'>" + "<a href='#add_pic' id='list_addPic'>"+"添加" +"</a>"+ "</span>" + "</td>"+
