	...
	$("div#updatePortrait span.sucServer").click(function(){
	 ...
	 $("#user_personalInfo .personalInfo_wrap .lj-btn").click(function(){
	 	$.post("/agent/modify_agent",{'name':$("input#username").val(),'sex':1,
	 		'age':$("input#age").val(),'email':$("input#email").val(),'year':$("input#year").val(),'company':$("input#company").val(),'phone':$("input#phone").val(),'introduciton':$("textarea#selfIntro").val()},function(result){
	 			if(result.code == 200){
	 				alert("个人信息修改成功");
