...
<head>
    ...
    <title>易居网介绍-易居价值观说明_让您了解一个全面真实的易居网</title>
    <meta name="description" content="了解易居，了解易居网，易居真实形象，易居网价值观">
    <meta name="keywords" content="易居，易居在线，易居网">
    <link href="/favicon.ico" type="image/x-icon" rel="icon">
    <link href="/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" href="http://static1.ljcdn.com/pc/asset/common.css?_v=20160818212022">
    <link rel="stylesheet" href="http://static1.ljcdn.com/pc/asset/specialPage/css/main.css?_v=20160818212022">
...
<body>
	...
	<div class="heroImage">
        ...
        <div class="banner-text fadeUp animateDelay0"></div>
    ...
    <div class="main" id="main">
            ...
            <div class="box">
                ...
                <div class="fl cun">
                    ...
                    <div class="name">
                     ...
                     <span> &nbsp&nbsp&nbsp烦恼找不到交通方便的住房？</span>

                    </div>

                    <div class="title">给你正确的找房姿势！</div>

                    <p>

                    <a href="">地铁房</a>、<a href="" target="_blank">学区房</a>、<a href="" target="_blank">地图找房</a>，想怎么搜就怎么搜！</p>

                </div>

                <div class="fr pic rightIn showbg"></div>
        ...
        <div class="box-main02">

            <div class="box">

                <div class="fl pic leftIn showbg"></div>
                ...
                <div class="fr cun">
                    ...
                    <div class="name">
                        ...
                        <span>网上看图满欢喜，真实落地空欢喜？&nbsp;</span>

                    </div>

                    <div class="title">真实房源<br>你放心找！</div>

                    <p>易居承诺假一赔百，不服你就来举报。</p>
        ...
        <div class="box-main03">
            ...
            <div class="box">
                ...
                <div class="fl cun">
                    ...
                    <div class="title">真实成交数据 <br>轻松选出性价比最高的</div>

                    <p>易居网公开房屋成交价，让你不花冤枉钱。</p>
...
__STAT_LJ_CONF = {
    ...
    params: {
        ...
        ljweb_sample: (document.cookie.match(/(?:^| )sample(?:(?:=([^;]*))|;|$)/) || ['',''])[1],

        ljweb_ref: document.referrer,

        ljweb_cid: '',

        ljweb_channel: 'zhuanti',
